...
-- @hover: (34,56)[export type HttpRequestOptions = {
    headers: {
        [string]: string
    }?,
...
http.request(host: string, opts: HttpRequestOptionsType<"string"?>?): HttpResponse<string>
...
http.request(host: string, opts: HttpRequestOptionsType<"buffer">?): HttpResponse<buffer>
-- @hover: (34,56)[export type HttpRequestOptions = {
    headers: {
        [string]: string
    }?,
...
-- @hover: (87,99)[export type HttpResponse<T> = {
    ok: boolean,
    status_code: number,
    status_reason: string,
    headers: {
...
http.request(host: string, opts: HttpRequestOptionsType<"string" | "buffer" | nil>?): HttpResponse<string | buffer>
```
<details open>
<summary>Parameters</summary>
- `host: string{:luau}` - The host to make the request to.
- `opts: HttpRequestOptionsType?{:luau}` - The options for the request.
</details>
<details>
<summary>Throws</summary>
- Request Error
