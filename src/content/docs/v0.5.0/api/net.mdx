...
```luau tooltips
-- @hover: (47,61)[export type NetworkAddress = {
    family: number,
    port: number,
    address: string, 
}]
...
-- @link: (33,43)[../objects/HttpServer]
http.serve(opts: ServeOptions): HttpServer
```
<details open>
<summary>Parameters</summary>
...
```luau tooltips
-- @hover: (34,52)[export type RequestOptions = {
    headers: {
        [string]: string
    }?,
...
type RequestOptionsType<T> = (RequestOptions & {
    response_body_type: T
})]
-- @hover: (67,79)[export type HttpResponse<T> = {
    ok: boolean,
    status_code: number,
...
http.request(host: string, opts: RequestOptionsType<"string"?>?): HttpResponse<string>
-- @hover: (66,78)[export type HttpResponse<T> = {
    ok: boolean,
    status_code: number,
    status_reason: string,
    headers: {
...
http.request(host: string, opts: RequestOptionsType<"buffer">?): HttpResponse<buffer>
-- @hover: (34,52)[export type RequestOptions = {
    headers: {
        [string]: string
    }?,
...
-- @hover: (83,95)[export type HttpResponse<T> = {
    ok: boolean,
    status_code: number,
    status_reason: string,
    headers: {
...
http.request(host: string, opts: RequestOptionsType<"string" | "buffer" | nil>?): HttpResponse<string | buffer>
```
<details open>
<summary>Parameters</summary>
- `host: string{:luau}` - The host to make the request to.
- `opts: RequestOptionsType?{:luau}` - The options for the request.
</details>
<details>
<summary>Throws</summary>
- Request Error
...
-- @link: (55,68)[../objects/HttpWebSocket]
http.websocket(host: string, opts: WebSocketOptions): HttpWebSocket
```
<details open>
<summary>Parameters</summary>
