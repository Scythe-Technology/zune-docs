...
export type FFIFunctionDefinition = {
    returns: FFIAnyDataType,
    args: {FFIAnyDataType}
}]
-- @link: (47,57)[../objects/FFIPointer]
fn(definition: FFIFunctionDefinition, srcPtr: FFIPointer): ((...any) -> any)
```
<details open>
<summary>Parameters</summary>
- `definition: FFIFunctionDefinition{:luau}` - The function definition.
...
-- @link: (71,81)[../objects/FFIPointer]
closure(definition: FFIFunctionDefinition, handler: (...any) -> any): FFIPointer
```
<details open>
<summary>Parameters</summary>
- `definition: FFIFunctionDefinition{:luau}` - The function definition.
...
dlopen(path: string, functions: {[string]: FFIFunctionDefinition}): FFILibrary
```
<details open>
<summary>Parameters</summary>
- `path: string{:luau}` - The path to the library.
- `functions: { [string]: FFIFunctionDefinition }{:luau}` - The symbols to load from the library.
</details>
<details>
<summary>Throws</summary>
- FFI Error
