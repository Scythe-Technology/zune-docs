...
## Properties
### MAX_READ
The maximum amount of bytes luau can run.
```luau
MAX_READ: number
```
...
```luau tooltips
-- @hover: (24,41)[type BufferSinkOptions = {
  limit: number?,
}]
...
<details open>
<summary>Parameters</summary>
- `buffer: buffer{:luau}` - The buffer to use for the stream.
</details>
<details>
<summary>Throws</summary>
- Memory Error
