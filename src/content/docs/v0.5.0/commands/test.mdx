...
```ansi
 ...
 │ [31m[string "filename"]:2: Error message[0m
 │ [31mpath/to/filename:4:2:[0m [2m0x123456 called error (test)[0m
 │     error("Error Message") -- Test code here
 │     ^
 │ [31mpath/to/filename:9:1:[0m [2m0x123456 called test (test)[0m
 │ testing.test("Test Name", function()
 └─       ^
